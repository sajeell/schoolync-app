...
import busIllustration from '../../assets/add-driver-bus.png'
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.formContainer}>
          <View style={styles.toggleWrapper}>
            ...
            >
              <Text style={styles.toggleOffText}>Bus</Text>
            </TouchableOpacity>
          </View>
          <Text style={styles.formHeading}>User Details</Text>
          ...
          <View style={styles.inputContainer}>
            <Image
              source={ageIcon}
              style={{ width: 22, height: 23, marginRight: 20 }}
            />
            <TextInput
          ...
          <View style={styles.inputContainer}>
            <Image
              source={lockIcon}
              style={{ width: 17, height: 23, marginRight: 20 }}
            />
            <TextInput
              keyboardType={'number-pad'}
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.formContainer}>
          <View style={styles.toggleWrapper}>
            ...
            >
              <Text style={styles.toggleOffText}>Driver</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.toggleOnRight}>
              <Text style={styles.toggleOnText}>Bus</Text>
            </TouchableOpacity>
          </View>
          <Text style={styles.formHeading}>Bus Details</Text>
          <ScrollView></ScrollView>
          <View style={styles.inputContainer}>
            <Image source={industryIcon} style={styles.inputIcon} />
            <TextInput
          ...
          <View style={styles.inputContainer}>
            <Image source={licenseIcon} style={{ width: 22, height: 17 }} />
            <TextInput
          ...
          <View style={styles.inputContainer}>
            <Image source={seatIcon} style={styles.inputIcon} />
            <TextInput
